condition_variable(my_devid:name).
condition_variable(my_mchan:number).
condition_variable(my_tstart:timetext).
condition_variable(my_tstop:timetext).
condition_variable(my_tsubmit:timetext).
condition_variable(my_loMin:number).
condition_variable(my_loMax:number).
condition_variable(my_laMin:number).
condition_variable(my_laMax:number).
