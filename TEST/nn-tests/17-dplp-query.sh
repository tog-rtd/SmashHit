...
curl -s -G "http://127.0.0.1:8001/pqapi/policy_sat" --data-urlencode "defs=testdefs" \
	--data-urlencode "policy=privacy_policy(dc1, [(p112,dpo22,dt1)])" \
	--data-urlencode "preference=privacy_preference(ds1, [(p11,dpo2,di1)])"

curl -s -G "http://127.0.0.1:8001/pqapi/policy_sat" --data-urlencode "defs=testdefs" \
	--data-urlencode "policy=privacy_policy(dc1, [(p1,dpo22,dt1)])" \
	--data-urlencode "preference=privacy_preference(ds1, [(p11,dpo2,di1)])"

curl -s -G "http://127.0.0.1:8001/pqapi/policy_sat" --data-urlencode "defs=testdefs" \
	--data-urlencode "policy=privacy_policy(dc1, [(p112,dpo2,dt1)])" \
	--data-urlencode "preference=privacy_preference(ds1, [(p11,dpo2,di1)])"

curl -s -G "http://127.0.0.1:8001/pqapi/policy_sat" --data-urlencode "defs=testdefs" \
	--data-urlencode "policy=privacy_policy(dc1, [(p112,dpo1,dt1)])" \
	--data-urlencode "preference=privacy_preference(ds1, [(p11,dpo2,di1)])"

curl -s -G "http://127.0.0.1:8001/pqapi/policy_sat" --data-urlencode "defs=testdefs" \
	--data-urlencode "policy=privacy_policy(dc1, [(p11,dpo22,dt1),(p112,dpo21,dt1)])" \
	--data-urlencode "preference=privacy_preference(ds1, [(p1,dpo2,di1)])"

curl -s -G "http://127.0.0.1:8001/pqapi/policy_sat" --data-urlencode "defs=testdefs" \
	--data-urlencode "policy=privacy_policy(dc1, [(p1,dpo22,dt1),(p112,dpo21,dt1)])" \
	--data-urlencode "preference=privacy_preference(ds1, [(p11,dpo2,di1)])"

curl -s -G "http://127.0.0.1:8001/pqapi/policy_sat" --data-urlencode "defs=testdefs" \
	--data-urlencode "policy=privacy_policy(dc1,  [(p1,dpo22,dt1),(p112,dpo21,dt1)])" \
	--data-urlencode "preference=privacy_preference(ds1,  [(p1,dpo2,di1),(p1,dpo2,di1)])"

curl -s -G "http://127.0.0.1:8001/pqapi/policy_sat" --data-urlencode "defs=testdefs" \
	--data-urlencode "policy=privacy_policy(dc1, [(p112,dpo1,dt1),(p112,dpo21,dt1)])"\
	--data-urlencode "preference=privacy_preference(ds1, [(p11,dpo2,di1),(p112,dpo1,di1)])"

curl -s -G "http://127.0.0.1:8001/pqapi/policy_sat" --data-urlencode "defs=testdefs" \
	--data-urlencode "policy=privacy_policy(dc1, [(p112,dpo1,dt1),(p112,dpo21,dt1),(p111,dpo12,dt1)])"\
	--data-urlencode "preference=privacy_preference(ds1, [(p11,dpo2,di1),(p112,dpo1,di1)])"

curl -s -G "http://127.0.0.1:8001/pqapi/policy_sat" --data-urlencode "defs=testdefs" \
	--data-urlencode "policy=privacy_policy(dc1, [(p112,dpo1,dt1),(p112,dpo21,dt1),(p111,dpo12,dt1)])"\
	--data-urlencode "preference=privacy_preference(ds1, [(p11,dpo22,di1),(p112,dpo1,di1)])"
