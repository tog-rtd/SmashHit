...
pdp_startup_tests([tc01,tc02,tc03,tc04,tc05,tc06,tc07,tc08,
		    ...
		    tcp01,tcp02,tcp03,tcp04,tcp05,tcp06,tcp07,tcp08,tcp09,
		    tcp21,tcp22,tcp23,tcp24,tcp25,tcp26,tcp27,tcp28,tcp29,tcp30
		   ]).
...
tcp21 :- privacy_sat(testdefs, privacy_policy(dc1, [(p112,dpo22,dt1)]),
		     privacy_preference(ds1, [(p11,dpo2,di1)]), (dc1,ds1):[] ).

tcp22 :- privacy_sat(testdefs, privacy_policy(dc1, [(p1,dpo22,dt1)]),
		     privacy_preference(ds1, [(p11,dpo2,di1)]), (dc1,ds1):[(p1, dpo22, dt1)] ).

tcp23 :- privacy_sat(testdefs, privacy_policy(dc1, [(p112,dpo2,dt1)]),
		     privacy_preference(ds1, [(p11,dpo2,di1)]), (dc1,ds1):[] ).

tcp24 :- privacy_sat(testdefs, privacy_policy(dc1, [(p112,dpo1,dt1)]),
		     privacy_preference(ds1, [(p11,dpo2,di1)]), (dc1,ds1):[(p112,dpo1,dt1)] ).

tcp25 :- privacy_sat(testdefs, privacy_policy(dc1, [(p11,dpo22,dt1),(p112,dpo21,dt1)]),
		     privacy_preference(ds1, [(p1,dpo2,di1)]), (dc1,ds1):[] ).

tcp26 :- privacy_sat(testdefs, privacy_policy(dc1, [(p1,dpo22,dt1),(p112,dpo21,dt1)]),
		     privacy_preference(ds1, [(p11,dpo2,di1)]), (dc1,ds1):[(p1,dpo22,dt1)] ).

tcp27 :- privacy_sat(testdefs, privacy_policy(dc1, [(p1,dpo22,dt1),(p112,dpo21,dt1)]),
		     privacy_preference(ds1, [(p1,dpo2,di1),(p1,dpo2,di1)]), (dc1,ds1):[] ).

tcp28 :- privacy_sat(testdefs, privacy_policy(dc1, [(p112,dpo1,dt1),(p112,dpo21,dt1)]),
		     privacy_preference(ds1, [(p11,dpo2,di1),(p112,dpo1,di1)]), (dc1,ds1):[] ).

tcp29 :- privacy_sat(testdefs, privacy_policy(dc1, [(p112,dpo1,dt1),(p112,dpo21,dt1),(p111,dpo12,dt1)]),
		     privacy_preference(ds1, [(p11,dpo2,di1),(p112,dpo1,di1)]), (dc1,ds1):[(p111,dpo12,dt1)] ).
