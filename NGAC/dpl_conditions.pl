...
:- module(dpl_conditions,[c_assign/3, c_associate/4, c_associate/5,
                          c_associatep/5, % DPLP
                          built_in_binary_relation_name/1,
...
:- use_module(dpl,[assign/3,associate/4,associate/5,cond/3,conditions/2]). % DPLP
:- use_module('COM/ui'). % because condition predicates may use timestamp conversions
...
:- use_module('EPP/epp_cpa',[condition_context_variable_map/2, read_context_cache/2]).
